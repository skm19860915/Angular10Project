...
export class DataService {
  ...
  addCampaignToFavorites(id, data) {
    let url = this.ADD_CAMPAIGN_TO_FAVORITES + id + '/';
    return this.patch(url, data);
  }

  removeCampaignFromCampaignFavorites(id, data) {
    let url = this.REMOVE_CAMPAIGN_FROM_CAMPAIGN_FAVORITES + id + '/';
    return this.patch(url, data);
  }
  ...
  addCampaignToMyList(id, data) {
    let url = this.ADD_CAMPAIGN_TO_MY_LIST + id + '/';
    return this.patch(url, data);
  }

  removeCampaignFromMyList(id, data) {
    let url = this.REMOVE_CAMPAIGN_FROM_MY_LIST + id + '/';
    return this.patch(url, data);
  }
  ...
  addInfluencerToFavoriteList(id, data) {
    let url = this.ADD_INFLUENCER_TO_FAVORITE_LIST + id + '/';
    return this.patch(url, data);
  }

  removeInfluencerFromInfluencerFavoriteList(id, data) {
    let url = this.REMOVE_INFLUENCER_FROM_INFLUENCER_FAVORITE_LIST + id + '/';
    return this.patch(url, data);
  }
  ...
  addInfluencerToMyList(id, data) {
    let url = this.ADD_INFLUENCER_TO_MYLIST + id + '/';
    return this.patch(url, data);
  }

  removeInfluencerFromMyList(id, data) {
    let url = this.REMOVE_INFLUENCER_FROM_MYLIST + id + '/';
    return this.patch(url, data);
  }
