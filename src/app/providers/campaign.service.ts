...
export class CampaignService {
    ...
    getFavoriteInfluencerListForBrand(){
        return new Promise((resolve) => {
            ...
            this.dataService.retrieveInfluencerToFavoriteList().subscribe(cdata => {
                if(cdata['results'][0]){
                    let favorite_list = cdata['results'][0].favorite_influencers; 
                    this.influencerFavoriteListId = cdata['results'][0].favorite_list_uuid;
    ...
    getMyListInfluencerListForBrand(){
        return new Promise((resolve) => {
            this.myList=[];
            this.dataService.retrieveMyListOfInfluencers().subscribe(cdata => {
                if(cdata['results'][0]){
                    let my_list = cdata['results'][0].mylist_influencers; 
                    this.influencerMyListId = cdata['results'][0].mylist_uuid;
    ...
    getFavoriteCampaignListForInfluencer(){
        return new Promise((resolve) => {
            ...
            this.dataService.retrieveFavoritedCampaignsList().subscribe(cdata => {
                if(cdata['results'][0]){
                    let favorite_list = cdata['results'][0].favorite_campaigns; 
                    this.campaignFavoriteListId = cdata['results'][0].favorite_list_uuid;
    ...
    getMyListCampaignListForInfluencer(){
        return new Promise((resolve) => {
            this.myCampList = [];
            this.dataService.retrieveCampaignToMyList().subscribe(cdata => {
                if(cdata['results'][0]){
                    let mylist_campaigns = cdata['results'][0].mylist_campaigns; 
                    this.campaignMyListId = cdata['results'][0].campaign_mylist_uuid;
